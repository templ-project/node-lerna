...
[![Contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/templ-project/node-lerna-typescript/issues)
...
<img alt="JavaScript Logo" src="https://github.com/templ-project/node-lerna-typescript/blob/main/typescript.svg?raw=true" width="20%" align="right" />
...
```bash
git clone https://github.com/templ-project/node-lerna-typescript your_project
cd your_project
rm -rf .git
git init
