...
[![Contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/templ-project/node-lerna-babel/issues)
...
<img alt="JavaScript Logo" src="https://github.com/templ-project/node-lerna-babel/blob/main/javascript.svg?raw=true" width="20%" align="right" />
...
```bash
git clone https://github.com/templ-project/node-lerna-babel your_project
cd your_project
rm -rf .git
git init
